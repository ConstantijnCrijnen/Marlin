...
// Name displayed in the LCD "Ready" message and Info menu
  ...
  #define CUSTOM_MACHINE_NAME "HFU Bot"
#endif
...
#define HEATER_0_MAXTEMP 290 //Maximum fuer Titan Aero ist 300
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 30.65 //Werte gemessen am 04.01.2021 mit 60% Fan Speed
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 23.30 //Werte gemessen am 11.12.2019 (mit 750W Silikonheizmatte)
  #define DEFAULT_bedKi 2.94
  #define DEFAULT_bedKd 123.13
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 800, 800, 10, 60 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 200, 1500 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 400, 3000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, 18, 0 } //Nur integer werte! (eigentlich: 38.5)
